...
use App\Http\Resources\UmkmResource;                    // ← TAMBAHAN
...
use App\Enums\UmkmStatus;                               // ← TAMBAHAN
use App\Enums\ProductStatus;                            // ← TAMBAHAN
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $umkms = Umkm::query()
            ...
            ->with([
                ...
                'category',
                'products' => fn($q) => $q
                    ->where('status', ProductStatus::AVAILABLE)  // atau 'available' string jika pakai enum biasa
                    ->select('id', 'umkm_id', 'name', 'price', 'image')
